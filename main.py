...
# @app.post("/search",
#              tags=["Search"])
# async def search(search_input: InputData):
#     """
#     Performs a search based on the provided query and answer type.
#     """
#     try:
...
#             return JSONResponse(status_code=601, content={"error": "Error: Query cannot be empty"})

#         result = rag_pipeline(query)

#         message = "Query: {0} | Time : {1} sec"
#         print(message.format(query, round(time.time() - start_time, 2)))
